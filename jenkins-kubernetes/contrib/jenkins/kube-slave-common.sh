...
NODEJS_SLAVE=${NODEJS_SLAVE_IMAGE:-hub.easystack.io/captain/jenkins-slave-nodejs:4.4}
MAVEN_SLAVE=${MAVEN_SLAVE_IMAGE:-hub.easystack.io/captain/jenkins-slave-maven3.3.}
# if the master is running the centos image, use the centos slave images.
if [[ `grep CentOS /etc/redhat-release` ]]; then
  NODEJS_SLAVE=${NODEJS_SLAVE_IMAGE:-hub.easystack.io/captain/jenkins-slave-nodejs:4.4}
  MAVEN_SLAVE=${MAVEN_SLAVE_IMAGE:-hub.easystack.io/captain/jenkins-slave-maven:3.3}
fi
