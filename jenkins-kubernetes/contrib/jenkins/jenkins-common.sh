...
export OPENSHIFT_API_URL=https://jpipe.default.svc.cluster.local
...
function obfuscate_password {
    ...
    java -classpath "${acegi_security_path}:${commons_codec_path}:/opt/jpipe/password-encoder.jar" com.redhat.openshift.PasswordEncoder $password $salt
}
